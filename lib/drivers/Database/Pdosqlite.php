...
class AetherDatabasePdosqliteDriver extends AetherDatabaseDriver {
	...
	public function connect() {
		...
		try {
			...
			throw new AetherDatabaseException('database.error', $e->getMessage());
		}
...
} // End AetherDatabasePdoSqliteDriver Class
...
class AetherPdosqliteResult extends AetherDatabaseResult {
	...
	public function __construct($result, $link, $object = TRUE, $sql) {
		if (is_object($result) OR $result = $link->prepare($sql)) {
			...
			// SQL error
			throw new AetherDatabaseException('database.error', $link->errorInfo().' - '.$sql);
		}
	...
	public function seek($offset) {
        ...
        // FIX
		Kohana::log('error', get_class($this).
                    ' does not support scrollable cursors, '.__FUNCTION__.' call ignored');
...
} // End AetherPdoSqliteResult Class